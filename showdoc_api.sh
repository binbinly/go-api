...
# 
api_key="722c6a7a9531362b04336c531548b227938795399" 			#api_key
api_token="0fdb5e0502906cee5f1bdc0123cc68911171130609" 	#api_token
url="http://192.168.1.250:4999/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
